...
##'
##' @seealso
##' \code{\link{SimInf_model}} (constructor) for creating model
##' objects.  \code{\link{SIR}}, \code{\link{SEIR}},
...
##' string syntax.  \code{\link{run}} for executing the simulation.
##' \code{\link{trajectory}}, \code{\link{prevalence}}, and
##' \code{\link{plot,SimInf_model-method}} for extracting and
##' visualizing results.  \code{\linkS4class{SimInf_events}} for
##' details on the event schedule structure.
##'
##' @export
setClass(
    "SimInf_model",
