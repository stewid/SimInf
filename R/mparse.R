...
##'     modify the C code afterwards, or when writing C code for the
##'     \code{pts_fun} parameter. Default is \code{FALSE}, i.e., the
##'     parameters are specified by using integer indices for the
##'     parameters.
