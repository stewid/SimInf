...
## Check that length of beta_t1 equals 1 or nrow(init)
res <- tools::assertError(SISe3(init      = init,
                                tspan     = seq_len(10) - 1,
                                events    = NULL,
                                phi       = rep(1, 6),
...
## Check that length of beta_t2 equals 1 or nrow(init)
res <- tools::assertError(SISe3(init      = init,
                                tspan     = seq_len(10) - 1,
                                events    = NULL,
                                phi       = rep(1, 6),
...
## Check that length of beta_t3 equals 1 or nrow(init)
res <- tools::assertError(SISe3(init      = init,
                                tspan     = seq_len(10) - 1,
                                events    = NULL,
                                phi       = rep(1, 6),
...
## Check that length of beta_t4 equals 1 or nrow(init)
res <- tools::assertError(SISe3(init      = init,
                                tspan     = seq_len(10) - 1,
                                events    = NULL,
                                phi       = rep(1, 6),
