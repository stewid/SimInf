 ...
 */
static double
SISe3_sp_S_1_to_I_1(const int *u,
                    const double *v,
 ...
 */
static double
SISe3_sp_S_2_to_I_2(const int *u,
                    const double *v,
                    const double *ldata, const double *gdata, double t)
{
    SIMINF_UNUSED(ldata);
 ...
 */
static double
SISe3_sp_S_3_to_I_3(const int *u,
                    const double *v,
                    const double *ldata, const double *gdata, double t)
{
    SIMINF_UNUSED(ldata);
 ...
 */
static double
SISe3_sp_I_1_to_S_1(const int *u,
                    const double *v,
                    const double *ldata, const double *gdata, double t)
{
    SIMINF_UNUSED(v);
 ...
 */
static double
SISe3_sp_I_2_to_S_2(const int *u,
                    const double *v,
                    const double *ldata, const double *gdata, double t)
{
    SIMINF_UNUSED(v);
 ...
 */
static double
SISe3_sp_I_3_to_S_3(const int *u,
                    const double *v,
                    const double *ldata, const double *gdata, double t)
{
    SIMINF_UNUSED(v);
 ...
 */
static int
SISe3_sp_post_time_step(double *v_new,
                        const int *u,
                        const double *v,
                        const double *ldata,
 ...
 */
attribute_hidden SEXP SISe3_sp_run(SEXP model, SEXP solver)
{
