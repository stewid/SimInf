...
(`I1+I2+I3+I4`). The `plot()` function allows us to specify a formula
where the left-hand side defines the "cases" and the right-hand side
defines the "at-risk" population.
