...
\mbox{\url{https://CRAN.R-project.org/package=SimInf}} and is
installed and loaded in \proglang{R} with the following commands
...
\section[Illustration: The SISe3_sp model]{Illustration: The \code{SISe3\_sp} model}
