...
realizations.  This is done by extracting the trajectory and calculate
successive differences at each time-point of \code{'Icum'}.
...
of incident cases in the first node exceeds what is observed on
average.
...
compartments = c("R", "F"), gdata = list(bR = 2, bF = 2, dR = 1,
K = 1000, alpha = 0.007, w = 0.0035, dF = 2))
