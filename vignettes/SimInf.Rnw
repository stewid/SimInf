...
differences at each time-point of \code{'Icum'}.
...
compartments <- c("R", "F")
model <- mparse(transitions = transitions, compartments = compartments,
gdata = c(bR = 2, bF = 2, dR = 1, K = 1000, alpha = 0.007,
w = 0.0035, dF = 2), u0 = cbind(R = 1000, F = 100), tspan = 1:100)
...
path <- tempdir()
package_skeleton(model, "PredatorPrey", path = path)
@
