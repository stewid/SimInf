...
function(model) {prevalence(run(model), numerator = "I", denominator = c("S", "I", "R"), type = "pop")[75]})
bnp <- run_outer(x, y, model, gamma ~ beta,
function(model) {prevalence(run(model), numerator = "I", denominator = c("S", "I", "R"), type = "bnp")[75]})
@
...
plot_nodes <- function(x) {
  numerator = c("I_1", "I_2", "I_3")
  denominator = c("S_1", "S_2", "S_3", "I_1", "I_2", "I_3")
  wnp <- prevalence(x, numerator, denominator, type = "wnp") > 0
